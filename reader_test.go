...
func TestBitsReader_ReadUint64(t *testing.T) {
	r := NewReader(bitsDatas[1])
	gotRet, _ := r.ReadUint64(32)
	wantRet := uint64(0x47400010)
	assert.Equal(t, wantRet, gotRet)
